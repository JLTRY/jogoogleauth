...
$document->addScript(JURI::root() . "/templates/protostar/html/mod_login/submitbutton.js");
...
<div class="login<?php echo $this->pageclass_sfx; ?>">
	...
	<form id="login-form" action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-horizontal well">
